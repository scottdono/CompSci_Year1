...
int main()
{
    ...
    do  //start do...while loop.
    {
        ...
        option=0;   //debug for imperfect input from user
        ...
        switch(option)
        {
            case 1: //what happens when "1" is entered by the user.
            {
                ...
                getchar();   //wait for entry before moving on.
                break;
            }
            ...
            {    
                ...
                else
                {
                    ...
                    {
                        random1=(rand()% 2);    //generates random numbers and assigns them into a variable.
                        random2=(rand()% 1);
                ...
                questions=0; //reset.
                sleep(3);   //wait for 4 seconds to allow the user to read and then continue.
                break;
            }
